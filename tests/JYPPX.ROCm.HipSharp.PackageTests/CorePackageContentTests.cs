...
namespace JYPPX.ROCm.HipSharp.PackageTests;
...
public sealed class CorePackageContentTests
{
    ...
    public void CandidatePackageContainsCompleteAssetsAndNoForbiddenPayload()
    {
        ...
        Assert.AreEqual("JYPPX.ROCm.HIP.CSharp.API", metadata.Element(ns + "id")!.Value);
    ...
    private static string LocatePackage()
    {
        ...
        return Directory.EnumerateFiles(packageDirectory, "JYPPX.ROCm.HIP.CSharp.API.*.nupkg")
