...
| `hiprtc-program-linker-0.10.0` (9) | HIPRTC lowered-name, bitcode, and linker ownership | `tests/JYPPX.ROCm.HipSharp.UnitTests/HipRtcTests.cs` | `not-tested`; fresh exact-SHA Radeon Cloud evidence required |
