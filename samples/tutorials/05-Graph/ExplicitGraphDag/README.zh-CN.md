# ExplicitGraphDag / 显式 Graph DAG

<p align="center"><a href="README.md">English</a> | <strong>简体中文</strong></p>

`ExplicitGraphDag` 是 05-Graph 模块中的教程案例。构建两节点有向无环图，检查拓扑，实例化并在 Stream 上启动。

## 本案例学习什么

本案例重点演示：HipGraph.AddEmpty、依赖边、HipGraph.Instantiate 和 HipGraphExec.Launch。
...
需要架构的案例请把 `gfx1100` 替换成 `rocminfo` 输出的实际值。矩阵中的 `ExplicitGraphDag` 状态是本案例的
权威云端结果。
...
| `ExplicitGraphDag.csproj` | .NET 目标框架和本地 HIPSharp 项目引用 |
