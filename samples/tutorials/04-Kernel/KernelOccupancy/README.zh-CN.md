# KernelOccupancy / Kernel 占用率

<p align="center"><a href="README.md">English</a> | <strong>简体中文</strong></p>

`KernelOccupancy` 是 04-Kernel 模块中的教程案例。编译简单 Kernel，并查询目标架构的 Occupancy 和建议启动计划。

## 本案例学习什么

本案例重点演示：HipKernel.GetOccupancy、HipOccupancyInfo 和 HipOccupancyPlan。
...
需要架构的案例请把 `gfx1100` 替换成 `rocminfo` 输出的实际值。矩阵中的 `KernelOccupancy` 状态是本案例的
权威云端结果。
...
| `KernelOccupancy.csproj` | .NET 目标框架和本地 HIPSharp 项目引用 |
