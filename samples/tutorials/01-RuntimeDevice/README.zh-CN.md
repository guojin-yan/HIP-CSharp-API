...
学习 HIP 初始化、Runtime/Driver 版本、设备枚举以及原生库加载诊断。

## 推荐顺序

- [EnvironmentAndDevice](./EnvironmentAndDevice/README.zh-CN.md)
- [LoaderDiagnostics](./LoaderDiagnostics/README.zh-CN.md)
