# LoaderDiagnostics / 原生库加载诊断

<p align="center"><a href="README.md">English</a> | <strong>简体中文</strong></p>

`LoaderDiagnostics` 是 01-RuntimeDevice 模块中的教程案例。展示 amdhip64 原生库加载路径，并在加载失败时保留候选路径诊断。

## 本案例学习什么

本案例重点演示：HipRuntime 加载、HipLibraryLoadException 和原生库加载诊断。
...
需要架构的案例请把 `gfx1100` 替换成 `rocminfo` 输出的实际值。矩阵中的 `LoaderDiagnostics` 状态是本案例的
权威云端结果。
...
| `LoaderDiagnostics.csproj` | .NET 目标框架和本地 HIPSharp 项目引用 |
