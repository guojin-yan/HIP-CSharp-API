# NativeAbiInterop / low-level native ABI

<p align="center"><strong>English</strong> | <a href="README.zh-CN.md">简体中文</a></p>

`NativeAbiInterop` is the 90-LowLevel tutorial case. Calls the generated HIP Runtime C ABI directly, checks raw HipError values, and reads the runtime version and device count.

## What This Teaches

This case focuses on HipRuntimeNativeApi, generated interop signatures, unsafe pointer arguments, and raw error handling.
...
`NativeAbiInterop` entry in the matrix is the authoritative cloud status for this tutorial.
...
The cloud log reports the raw runtime version and one visible device.
...
The case log is `logs/NativeAbiInterop.log`; `results.csv` records the status and exit code for all 20 tutorials.
...
| `NativeAbiInterop.csproj` | .NET target and local HIPSharp project reference |
