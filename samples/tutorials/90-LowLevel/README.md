...
Use the generated HIP Runtime C ABI directly as an expert reference; normal applications should use managed owners.

## Recommended Order

- [NativeAbiInterop](./NativeAbiInterop/README.md)
