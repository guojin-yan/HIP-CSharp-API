...
See `samples/HipAdvancedFeatures` for CPU/GPU comparison, graph replay, managed-memory validation, 100 owner lifecycles, and an explicit P2P enable-or-skip path.
