...
- Confirm Core `0.9.0`, Runtime `7.2.1`, repository metadata, dependency policy, and the package signing strategy.
- Require official-host and package-only PRoot final-mode results for the exact bytes; check loader origin, symbols, ABI, 1,127 comparisons, reliability and all four negatives.
