...
For the 0.9.1 forward-fix candidate, `eng/verify-public-api.ps1` compares the committed public API snapshot with every target assembly. All 15 TFMs must remain surface-identical; the pack step also runs NuGet package validation.
