...
`net7.0` and later use source-generated `LibraryImport`; older targets use `DllImport`. Runtime, Module/Launch, and HIPRTC declarations are generated from one manifest and compile through both branches.
