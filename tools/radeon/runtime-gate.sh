...
runtime_version="$(read_package_version "${runtime_package}" JYPPX.ROCm.HIP.CSharp.API.Runtime.ubuntu.24.04-x64)"
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    ...
    <PackageReference Include="JYPPX.ROCm.HIP.CSharp.API.Runtime.ubuntu.24.04-x64" Version="${runtime_version}" />
  </ItemGroup>
</Project>
EOF
...
sed -i '/JYPPX.ROCm.HIP.CSharp.API.Runtime.ubuntu.24.04-x64/d' "${core_only}/Consumer.csproj"
