...
dotnet run --project tools/JYPPX.ROCm.HipSharp.BindingGenerator -- probe-manifest
dotnet run --project tools/JYPPX.ROCm.HipSharp.BindingGenerator -- extract-headers --header-root ./artifacts/hip-headers --check
```
